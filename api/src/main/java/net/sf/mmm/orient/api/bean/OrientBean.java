 ...
 * access in a type-safe way. You can also access all properties via {@link BeanAccess#getProperty(String)}.
 * <br/>
 * <b>NOTE:</b><br/>
 * Never implement an {@link OrientBean} interface. See {@link Bean} and
...
public interface OrientBean extends EntityBean {
  ...
  /** {@link BeanAccess#getPropertyNameForAlias(String) alias} for the {@link #Id()}. */
  String PROPERTY_ALIAS_ID = "@rid";

  /** {@link BeanAccess#getPropertyNameForAlias(String) alias} for the {@link Id#getVersion() version}. */
