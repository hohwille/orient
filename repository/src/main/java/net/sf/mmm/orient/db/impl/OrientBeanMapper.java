 ...
 * @since 1.0.0
 */
public interface OrientBeanMapper {
   ...
   * @return the corresponding {@link OrientBean} {@link BeanFactory#createPrototype(Class, boolean) prototype}.
   */
  ...
  /**
   * @param bean the {@link OrientBean} to map.
   * @param document the existing {@link ODocument OrientDB document} instance to update from the given {@code bean} or
