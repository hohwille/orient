...
public abstract interface AbstractPropertyBuilder {
   ...
   * {@link net.sf.mmm.bean.api.BeanPrototypeBuilder#createPrototype(Class, String, net.sf.mmm.bean.api.Bean...)
   * prototype}.
   *
   * @see net.sf.mmm.bean.api.BeanAccess#getOrCreateProperty(String, net.sf.mmm.util.reflect.api.GenericType,
   *      Class)
   *
   ...
   *        {@link net.sf.mmm.bean.api.BeanPrototypeBuilder#createPrototype(Class, String, net.sf.mmm.bean.api.Bean...)
   *        prototype}.
   * @return the {@link WritableProperty property} corresponding to the given {@link OProperty} that has been
   *         created or was already existing. May be {@code null} if the {@link OProperty#getType() property
   *         type} is not supported (e.g. if new version of OrientDB introduces new property type that has not
