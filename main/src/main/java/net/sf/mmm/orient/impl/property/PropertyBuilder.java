...
/**
 * This is the interface for the {@link AbstractPropertyBuilder property builder} assembled automatically from
 * various {@link SinglePropertyBuilder}-instances.
 *
 * @author hohwille
 * @since 1.0.0
 */
...
public interface PropertyBuilder extends AbstractPropertyBuilder {
   ...
   * @return the {@link SinglePropertyBuilder} {@link SinglePropertyBuilder#getType() responsible} for the
   *         given {@link OType}.
   */
   ...
   * @param type the raw {@link Class} of the {@link net.sf.mmm.property.api.WritableProperty#getType() bean
   *        property value type}.
   * @return the {@link SinglePropertyBuilder} {@link SinglePropertyBuilder#getType() responsible} for the
   *         given {@link Class}.
   */
